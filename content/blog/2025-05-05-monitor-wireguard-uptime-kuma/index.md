...
{{ responsive_image(src="wireguard-monitor-in-dashboard.png", alt="Screenshot of active Wireguard monitor in Uptime Kuma dashboard", caption="Wireguard monitor in Uptime Kuma", lazy=false) }}
